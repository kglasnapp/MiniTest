...
public class BalanceCommand extends CommandBase {
    ...
    public void initialize() {
        ...
        // KAG DefaultDriveCommand.autonomous = true;
        // KAG SwerveModule.powerRatio = 1.4; 
    }
    ...
    public void end(boolean interrupted) {
        drivetrainSubsystem.stop();
        // KAG DefaultDriveCommand.autonomous = false;
        // KAG SwerveModule.powerRatio = SwerveModule.TURBO; 
    }
